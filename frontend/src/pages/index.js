...
const Homepage = ({ packages }) => {
  ...
  return (
    <>
      ...
      {/* Hero Section */}
      <section className="relative h-[90vh] md:h-screen bg-gray-900 overflow-hidden flex items-center">
        <div 
        ...
        <div className="relative container mx-auto px-4">
          <div className="max-w-2xl text-white space-y-6">
            ...
            <p className="text-lg lg:text-2xl text-gray-200 leading-relaxed">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-block bg-[#7ac144] hover:bg-emerald-600 text-white px-8 py-3 text-lg font-semibold rounded-xl transition-all duration-300 transform hover:scale-105"
            >
              Book a Test Now
            </a>
          </div>
      ...
      <section className="py-12 md:py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-[#1c515c] mb-3">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              ...
              <div key={index} className="bg-blue-50 text-center p-6 rounded-xl transition-all duration-300 transform hover:-translate-y-2">
                <div className="text-4xl mb-4">{item.icon}</div>
                <h3 className="text-lg font-semibold text-[#1e535e] mb-2">{item.title}</h3>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            <div className="md:w-1/2 text-center md:text-left">
              <h2 className="text-3xl md:text-4xl font-bold text-[#1c515c] mb-4">
                Trusted Accreditations
              </h2>
              <p className="text-gray-600 mx-auto md:mx-0 text-base md:text-lg leading-relaxed max-w-xl">
                National Accreditation Board for Testing and Calibration Laboratories (NABL) and International Laboratory Accreditation Cooperation (ILAC) accreditations ensure that labs follow the stringent quality protocols set up by these bodies.
              </p>
            </div>
            <div className="md:w-1/2 flex justify-center md:justify-end items-center gap-8">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="flex justify-center mb-10">
            <div className="flex flex-wrap justify-center gap-2">
              <button className="px-5 py-2 bg-[#1c515c] text-white rounded-full font-medium text-sm">Most Booked</button>
              <button className="px-5 py-2 text-gray-600 hover:bg-gray-100 rounded-full font-medium text-sm border">Heart Health</button>
              <button className="px-5 py-2 text-gray-600 hover:bg-gray-100 rounded-full font-medium text-sm border">Full Body Checkup</button>
              <button className="px-5 py-2 text-gray-600 hover:bg-gray-100 rounded-full font-medium text-sm border">Sexual Health</button>
            </div>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {packages.slice(0, 4).map((pkg) => (
              <Link key={pkg.id} href={`/packages/${pkg.slug || pkg.name.replace(/\s+/g, '-').toLowerCase()}`}>
                <a className="block bg-white p-6 rounded-lg border hover:shadow-lg hover:-translate-y-1 transition-all">
                  ...
                  <div className="w-full bg-[#7ac144] text-white text-center py-2.5 rounded-md font-medium">Book Now</div>
                </a>
              </Link>
            ))}
          </div>
          <div className="text-center">
            <Link href="/packages">
              <a className="inline-block border border-gray-400 text-gray-800 px-8 py-3 rounded-md hover:bg-gray-100 font-semibold">
                View All Packages
              </a>
            </Link>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Thanks to cutting-edge automation and expert validation, we process samples quickly while maintaining the highest quality standards. Most reports are completed within 6–12 hours.
              </p>
              <div className="space-y-3">
                {['Same-day report delivery for most tests', 'Digital access via WhatsApp and Email', 'Expert-verified for 100% accuracy'].map((item, index) => (
            ...
            <div className="relative w-full h-80 rounded-xl overflow-hidden">
              <Image src="/images/ReportFast.png" alt="Laboratory microscope" layout="fill" objectFit="cover" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-10">
            {[
              ...
              <div key={index} className="text-center p-6 rounded-xl bg-blue-50">
                <div className="bg-[#1c515c] rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">{feature.icon}</div>
                <h3 className="text-lg font-semibold text-[#1c515c] leading-tight">{feature.title}</h3>
              </div>
            ))}
          </div>
          <div className="text-center">
            <a href="https://wa.me/918828826646?text=Hello%20ViLife%20Diagnostics.%20I%20would%20like%20to%20book%20a%20home%20visit." target="_blank" rel="noopener noreferrer" className="inline-block bg-[#7ac144] hover:bg-green-600 text-white px-8 py-3 rounded-lg font-medium">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="flex space-x-1 mt-1">
                      {[...Array(5)].map((_, i) => (<svg key={i} className="w-4 h-4 text-orange-400" fill="currentColor" viewBox="0 0 20 20"><path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" /></svg>))}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            <div className="relative w-full h-80 rounded-2xl overflow-hidden">
              <Image src="/images/GmapsLocation.png" alt="ViLife locations on Google Maps" layout="fill" objectFit="cover" />
            </div>
            <div>
              <h2 className="text-3xl md:text-4xl font-bold text-[#1c515c] mb-4">
              ...
              <p className="text-lg text-gray-600 mb-6 leading-relaxed">
                Our clinics are strategically located near airports and major transport hubs, ensuring quick and easy access for all your diagnostic needs.
              </p>
              <div className="space-y-3">
                {[
                  ...
                  <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 cursor-pointer" onClick={() => window.open(location.googleMapsUrl, '_blank')}>
                    <div className="flex items-center space-x-3">
          ...
          <div className="flex flex-col-reverse md:flex-row md:items-center gap-8">
            <div className="md:w-1/2 text-center md:text-left">
              ...
              <p className="text-gray-600 mx-auto md:mx-0 text-lg mb-6 leading-relaxed max-w-xl">
                ViLife Diagnostics believes in the ideology of quality, precision, timeliness. We are equipped with technologically advanced fully automated machinery carefully selected to provide accurate results.
              </p>
              <Link href="/about">
                <a className="inline-block bg-transparent border border-gray-400 text-gray-700 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100">
                  Read More
                </a>
              </Link>
            </div>
            <div className="md:w-1/2 flex justify-center md:justify-end">
              <div className="rounded-xl overflow-hidden w-full relative h-80">
                <Image src="/images/LabPhoto.webp" alt="ViLife Diagnostics Lab" layout="fill" objectFit="cover" />
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid md:grid-cols-2 gap-x-6 gap-y-3">
              {[
                ...
                <details key={index} className="group bg-white rounded-lg p-1">
      ...
      <section className="relative py-16 md:py-20 overflow-hidden">
        <div className="absolute inset-0 bg-cover bg-center" style={{ backgroundImage: `url('/images/BookHomeCollection.jpg')` }}>
          <div className="absolute inset-0 bg-black/80"></div>
        </div>
        <div className="relative container mx-auto px-4">
          <div className="flex flex-col items-center text-center gap-6 md:flex-row md:justify-between md:text-left">
            <div className="text-white">
              <h2 className="text-3xl md:text-4xl font-bold mb-2">Book Your Home Collection</h2>
              <p className="text-lg md:text-xl text-gray-200">Get exclusive packages on your first healthcare test.</p>
            </div>
            <div className="flex-shrink-0">
              <a href="https://wa.me/918828826646?text=Hello%20ViLife%20Diagnostics.%20I%20would%20like%20to%20book%20a%20home%20visit." target="_blank" rel="noopener noreferrer" className="inline-block bg-white text-gray-800 px-8 py-3 rounded-lg font-semibold hover:bg-gray-100">
                Book a Home Visit
              </a>
            </div>
          </div>
