...
// Import Supabase client (make sure ../lib/supabaseClient.js exists)
  ...
  cors({
    origin:
      process.env.NODE_ENV === 'production'
        ? [
            'https://vi-life-diagnostics.vercel.app',
            'https://www.vlifediagnostics.com',
          ]
...
// Health check endpoint (using Supabase instead of pool)
